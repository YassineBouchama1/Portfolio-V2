...
export default function CardProject2({ data }) {
    ...
    return (
        <motion.div className={`card-project ${data.directionCard}`}
        ...
        >
            ...
            <motion.div
                ...
                className='card-img-mobile'><img src={`https://raw.githubusercontent.com/SiskoWeb/Portfolio-V2/main/src${data.image}`}></img></motion.div>
            <motion.div
                initial={{ scale: 0 }}
                whileInView={{ scale: 1 }}
                viewport={{ once: false }}
                ...
                className='card-img'><a><img src={`https://raw.githubusercontent.com/SiskoWeb/Portfolio-V2/main/src${data.image}`}></img></a></motion.div>
